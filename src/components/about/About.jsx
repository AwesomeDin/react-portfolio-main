    ...
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          {/* <Info /> */}
          <p className="about__description" style={{ fontSize: "1.1rem" }}>
            Hello, I'm currently a senior majoring in Computer Science with a
            minor in Business at the University of Central Florida. I'm all
